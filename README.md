...
Feel free to explore my resume, projects, and achievements. You can also reach out to me through the social media links provided in the footer.

---

## License

This portfolio is built using an open-source template from BootstrapMade. See [License](https://bootstrapmade.com/license/) for more details.
